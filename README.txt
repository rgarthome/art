...
VARIANTA FLAT:
- index.html, product.html, style.css si app.js sunt in acelasi folder principal.
- Folderul netlify/functions trebuie pastrat asa pentru functia API products.
